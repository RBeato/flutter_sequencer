...
extern "C" __attribute__((visibility("default"))) __attribute__((used)) void JNICALL Java_com_example_flutter_1sequencer_FlutterSequencerPlugin_setupAssetManager(
